...
function util.VideoPlayer:GetTexture()
	return self.m_texture
end
function util.VideoPlayer:IsFileLoaded()
	return self.m_fileLoaded or false
end
function util.VideoPlayer:IsReady()
	return self.m_ready or false
end
...
function util.VideoPlayer:IsPaused(...)
	return self.m_player:IsPaused(...)
end
function util.VideoPlayer:IsPlaying(...)
	return self.m_player:IsPlaying(...)
end
...
function util.VideoPlayer:Seek(...)
	self.m_player:Seek(...)
end
function util.VideoPlayer:GoToNextFrame(...)
	self.m_player:GoToNextFrame(...)
end
function util.VideoPlayer:GoToPreviousFrame(...)
	self.m_player:GoToPreviousFrame(...)
end
function util.VideoPlayer:GetDuration(...)
	return self.m_player:GetDuration(...)
end
function util.VideoPlayer:GetWidth(...)
	return self.m_player:GetWidth(...)
end
function util.VideoPlayer:GetHeight(...)
	return self.m_player:GetHeight(...)
end
function util.VideoPlayer:SetVolume(volume)
	self.m_volume = volume
end
function util.VideoPlayer:GetVolume(...)
	return self.m_player:GetVolume(...)
end
function util.VideoPlayer:GetPlaybackTime(...)
	return self.m_player:GetPlaybackTime(...)
end
function util.VideoPlayer:SetLooping(...)
	return self.m_player:SetLooping(...)
end
function util.VideoPlayer:IsLooping(...)
	return self.m_player:IsLooping(...)
end
function util.VideoPlayer:SetMuted(...)
	return self.m_player:SetMuted(...)
end
function util.VideoPlayer:IsMuted(...)
	return self.m_player:IsMuted(...)
end
...
function util.VideoPlayer:Draw(drawSceneInfo)
	...
	if self.m_player:GetVolume() ~= vol then
		self.m_player:SetVolume(vol)
	end

	self.m_player:UpdateEvents()
	if self.m_player:IsReady() == false then
		return
	end
...
function util.VideoPlayer:InitializeTexture(w, h)
	if self.m_framebuffer ~= nil and w == self.m_framebuffer:GetWidth() and h == self.m_framebuffer:GetHeight() then
		return
	end
